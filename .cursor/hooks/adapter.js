...
function getPluginRoot() {
  // Cursor installs hook scripts under .cursor/scripts/hooks (not project-root/scripts).
  return path.resolve(__dirname, '..'); // patched: scripts live under .cursor/scripts
}
